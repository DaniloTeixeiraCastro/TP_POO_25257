namespace Tourist_Accommodation_System
{
    partial class FormManagementClient
    {
        ...
        private ToolStripMenuItem removeClToolStripMenuItem;
        private ToolStripMenuItem accomodationToolStripMenuItem;
        private ToolStripMenuItem addAcommodationToolStripMenuItem;
        private ToolStripMenuItem editAccommodationToolStripMenuItem;
        private ToolStripMenuItem listClientToolStripMenuItem;
        private ToolStripMenuItem removeAccommodationToolStripMenuItem;
        private ToolStripMenuItem listAccommodationToolStripMenuItem;
        private ToolStripMenuItem reservationToolStripMenuItem;
        private ToolStripMenuItem addReservationToolStripMenuItem;
        private ToolStripMenuItem editReservationToolStripMenuItem;
        private ToolStripMenuItem removeReservationToolStripMenuItem;
        private ToolStripMenuItem reviewToolStripMenuItem;
        private ToolStripMenuItem addReviewToolStripMenuItem;
        private ToolStripMenuItem editReviewToolStripMenuItem;
